...
<head>
  ...
  <title>Sensor Past History </title>
...
<div class="container" style="width: 99%;" style="background-color:#cbc4b7;">
  <h3 align="center">Past History </h3>
  <br/>
  <div class="panel panel default" style="background-color:#bccac9;">

    <div class="panel-body">
      <div class="table-responsive">
        <table id="blacksites" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th>UID</th>
              <th>Status</th>
...
console.log("duid");
var fetch= "fetch3.php"
if(duid!=null)
{
  fetch="fetch3.php?duid="+duid;
}
console.log(fetch);
