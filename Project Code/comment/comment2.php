...
<div class="container" style="width: 95%;" style="background-color:#cbc4b7;">
  <h3 align="center">Sensor Currrent Data </h3>
  <br/>
  <div class="panel panel default" style="background-color:#bccac9; padding:30px;">

    <div class="panel-body">
      <!--<div class="table-responsive">-->
      <div class="table-responsive" style="background-color:#bccac9;" >
...
console.log("duid");
var fetch= "fetch2.php"
if(duid!=null)
{
  fetch="fetch2.php?duid="+duid;
}
console.log(fetch);
